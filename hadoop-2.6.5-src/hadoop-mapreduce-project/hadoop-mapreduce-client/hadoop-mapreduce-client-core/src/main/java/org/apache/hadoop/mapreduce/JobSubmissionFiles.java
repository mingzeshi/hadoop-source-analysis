...
public class JobSubmissionFiles {
  ...
  throws IOException,InterruptedException {
    Path stagingArea = cluster.getStagingAreaDir(); // cluster获取任务的临时文件存放路径
    FileSystem fs = stagingArea.getFileSystem(conf); // 获取文件系统
    String realUser;
    String currentUser;
    ...
    return stagingArea; // 返回临时文件存放目录，是个.staging的目录
  }
